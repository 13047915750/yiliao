...
export default {
  ...
  methods: {
    initChart() {
      ...
      const xData = this.xData.map(item => {
          ...
          formatter: (params, ticket, callback) => {
            ...
            for (var i = 0; i < l; i++) {
              if (params[i].seriesName === '成功') {
                relVal += '<br/><span style="display:inline-block;background:#409EFF;border-radius:50%;width:10px;height:10px;line-height:20px; margin-right:5px"></span>' + params[i].seriesName + ' : ' + params[i].value
                ...
                relVal += '<br/><span style="display:inline-block;background:#42b983;border-radius:50%;width:10px;height:10px;line-height:20px; margin-right:5px"></span>' + params[i].seriesName + ' : ' + params[i].value
              }
            }
            if (i === 3) {
